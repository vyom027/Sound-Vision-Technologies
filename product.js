...
function cctv1() {
    ...
    document.getElementById("mainimg").src = "./image/cctv/dahua1.1.png";
    document.getElementById("smimg1").src = "./image/cctv/dahua1.2.png";
    document.getElementById("smimg2").src = "./image/cctv/dahua1.3.png";
...
function cctv2() {
    ...
    document.getElementById("pro").style.display = "flex";
    document.documentElement.classList.add("no-scroll"); 
    document.getElementById("mainimg").src = "./image/cctv/dahua2.1.png";
    document.getElementById("smimg1").src = "./image/cctv/dahua2.2.jpg";
    document.getElementById("smimg2").src = "./image/cctv/dahua2.3.png";
    document.getElementById("smimg3").src = "./image/cctv/dahua2.4.png";
    document.getElementById("product-title").innerHTML = pname;
...
function cctv3() {
    ...
    document.getElementById("pro").style.display = "flex";
    document.documentElement.classList.add("no-scroll"); 
    document.getElementById("mainimg").src = "./image/cctv/dahua3.1.png";
    document.getElementById("smimg1").src = "./image/cctv/dahua3.2.png";
    document.getElementById("smimg2").src = "./image/cctv/dahua3.3.png";
    document.getElementById("smimg3").style.display = "none";
    document.getElementById("product-title").innerHTML = pname;
...
function cctv4() {
    ...
    document.getElementById("pro").style.display = "flex";
    document.documentElement.classList.add("no-scroll"); 
    document.getElementById("mainimg").src = "./image/cctv/dahua4.1.png";
    document.getElementById("smimg1").src = "./image/cctv/dahua4.2.png";
    document.getElementById("smimg2").src = "./image/cctv/dahua4.3.png";
    document.getElementById("smimg3").style.display = "none";
    document.getElementById("product-title").innerHTML = pname;
...
function cctv5() {
    ...
    document.getElementById("pro").style.display = "flex";
    document.documentElement.classList.add("no-scroll"); 
    document.getElementById("mainimg").src = "./image/cctv/Hikvision1.1.png";
    document.getElementById("smimg1").src = "./image/cctv/Hikvision1.2.png";
    document.getElementById("smimg2").src = "./image/cctv/Hikvision1.3.png";
    document.getElementById("smimg3").style.display = "none";
    document.getElementById("product-title").innerHTML = pname;
...
function cctv6() {
    ...
    document.getElementById("pro").style.display = "flex";
    document.documentElement.classList.add("no-scroll"); 
    document.getElementById("mainimg").src = "./image/cctv/Hikvision2.1.png";
    document.getElementById("smimg1").src = "./image/cctv/Hikvision2.2.png";
    document.getElementById("smimg2").src = "./image/cctv/Hikvision2.3.png";
    document.getElementById("smimg3").style.display = "none";
    document.getElementById("product-title").innerHTML = pname;
...
function cctv7() {
    ...
    document.getElementById("pro").style.display = "flex";
    document.documentElement.classList.add("no-scroll"); 
    document.getElementById("mainimg").src = "./image/cctv/Hikvision3.1.png";
    document.getElementById("smimg1").src = "./image/cctv/Hikvision3.2.png";
    document.getElementById("smimg2").src = "./image/cctv/Hikvision3.3.png";
    document.getElementById("smimg3").style.display = "none";
    document.getElementById("product-title").innerHTML = pname;
...
function cctv8() {
    ...
    document.getElementById("pro").style.display = "flex";
    document.documentElement.classList.add("no-scroll"); 
    document.getElementById("mainimg").src = "./image/cctv/Hikvision4.1.png";
    document.getElementById("smimg1").src = "./image/cctv/Hikvision4.2.png";
    document.getElementById("smimg2").src = "./image/cctv/Hikvision4.3.png";
    document.getElementById("smimg3").style.display = "none";
    document.getElementById("product-title").innerHTML = pname;
...
function cctv9() {
    ...
    document.getElementById("pro").style.display = "flex";
    document.documentElement.classList.add("no-scroll"); 
    document.getElementById("mainimg").src = "./image/cctv/Secureye1.1.png";
    document.getElementById("smimg1").src = "./image/cctv/Secureye1.2.png";
    document.getElementById("smimg2").src = "./image/cctv/Secureye1.3.png";
    document.getElementById("smimg3").style.display = "none";
    document.getElementById("product-title").innerHTML = pname;
    document.getElementById("price").innerHTML = "₹ 1,500";
    document.getElementById("product-detail-p1").innerHTML = "";
...
function cctv10() {
    ...
    document.getElementById("pro").style.display = "flex";
    document.documentElement.classList.add("no-scroll"); 
    document.getElementById("mainimg").src = "./image/cctv/Secureye2.1.png";
    document.getElementById("smimg1").src = "./image/cctv/Secureye2.2.png";
    document.getElementById("smimg2").src = "./image/cctv/Secureye2.3.png";
    document.getElementById("smimg3").src = "./image/cctv/Secureye2.4.png";
    document.getElementById("product-title").innerHTML = pname;
...
function cctv11() {
    ...
    document.getElementById("pro").style.display = "flex";
    document.documentElement.classList.add("no-scroll"); 
    document.getElementById("mainimg").src = "./image/cctv/Secureye3.1.png";
    document.getElementById("smimg1").src = "./image/cctv/Secureye3.2.png";
    document.getElementById("smimg2").src = "./image/cctv/Secureye3.3.png";
    document.getElementById("smimg3").style.display = "none";
    document.getElementById("product-title").innerHTML = pname;
